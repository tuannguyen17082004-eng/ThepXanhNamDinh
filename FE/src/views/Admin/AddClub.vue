...
import { CreateClub } from '@/utils/ClubUtils';
...
const handleCreateClub = async () => {
    ...
    const res = await CreateClub(logo_file.value, name.value, shortname.value, logo_url.value);
    if (res) {
    ...
    <main class="container-fluid p-3" style="height: 100dvh">
        <div class="container-fluid px-3 py-4 d-flex align-items-center"
            ...
            <div id="title_club" class="container-fluid p-0 pe-5 m-0">
                <h5 class="m-0">Thêm câu lạc bộ</h5>
        ...
        <form id="add_form" class="container-fluid p-3 mt-4" @submit.prevent="handleCreateClub">
